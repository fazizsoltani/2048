      ...
      <div className="app">
        <div className="game-header">
          ...
          <div className="score-container">
            ...
            {this.state.addition !== 0 && (
              <div className="score-addition">+{this.state.addition}</div>
            )}
          </div>
        </div>
        ...
        <div className="game-container">
          {(this.state.won || this.state.over) && (
            <div
              className={`game-message game-${
                (this.state.won && "won") || (this.state.over && "over")
              }`}
            >
              <p>{this.state.won ? "You win!" : "Game over!"}</p>

              <div className="actions">
                <button className="retry-button" onClick={this.restart}>
                  Try again
                </button>
              </div>
            </div>
